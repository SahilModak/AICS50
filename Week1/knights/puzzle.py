...
knowledge2 = And(
    ...
    And(AKnave, And(Not(And(AKnight, BKnight)), Not(And(AKnave, BKnave))))),

    Or(And(BKnight, And(Not(And(AKnight, BKnight)), Not(And(AKnave, BKnave)))), 
    And(BKnave, Or(And(BKnight, AKnight), And(AKnave, BKnave))))
)
...
knowledge3 = And(
    ...
    Or(And(AKnight, Or(AKnave, AKnight)), And(AKnave, And(Not(AKnave), Not(AKnight)))),
